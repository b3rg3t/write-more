...
- API instructions: `.github/instructions/api/api.instructions.md`
- Client instructions: `.github/instructions/client/client.instructions.md`
- Client MUI skill: `.github/instructions/client/client-mui.skill.md`
